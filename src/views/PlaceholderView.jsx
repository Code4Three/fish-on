  ...
  return (
    <main className="placeholder-view">
      ...
      <div className="placeholder-panel">
        ...
        <p>The global menu and active location are connected. Detailed {viewKey} data will be added in a follow-up story.</p>
        <button type="button" onClick={() => navigateTo("weekly")}>Back to Weekly Forecast <span aria-hidden="true">&rarr;</span></button>
      </div>
    </main>
  );
}
